...
function getImageUrl(value) {
    ...
    // Markdown:
    // [https://site.com/resim.jpg](https://site.com/resim.jpg)
    ...
    // Eğer markdown sadece link olarak geldiyse
...
function findProductImage(item) {
    ...
    // 2 - Aynı stok kodundaki herhangi bir beden
    if (stokKodu) {
